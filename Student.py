...
class Student:
    def __init__(self,root):
        ...
        # ================== Images (fallback to solid color if missing) ==================
        try:
            img = Image.open(r"C:\Users\user\OneDrive\Desktop\Python_Test_Projects\college_iimages\KK1.jpeg")
        ...
        try:
            img1 = Image.open(r"C:\Users\user\OneDrive\Desktop\Python_Test_Projects\college_iimages\JSS.jpeg")
            img1 = img1.resize((500, 150), Image.LANCZOS)
            self.photoimg1 = ImageTk.PhotoImage(img1)
            f_lbl1 = Label(self.root, image=self.photoimg1)
            f_lbl1.place(x=500, y=0, width=500, height=150)
        except:
            f_lbl1 = Label(self.root, bg="gray")
            f_lbl1.place(x=500, y=0, width=500, height=150)

        try:
            img2 = Image.open(r"C:\Users\user\OneDrive\Desktop\Python_Test_Projects\college_iimages\KK1.jpeg")
            img2 = img2.resize((500, 150), Image.LANCZOS)
            self.photoimg2 = ImageTk.PhotoImage(img2)
            f_lbl2 = Label(self.root, image=self.photoimg2)
            f_lbl2.place(x=1000, y=0, width=500, height=150)
        except:
            f_lbl2 = Label(self.root, bg="gray")
            f_lbl2.place(x=1000, y=0, width=500, height=150)

        try:
            img3 = Image.open(r"C:\Users\user\OneDrive\Desktop\Python_Test_Projects\college_iimages\OIP.webp")
            img3 = img3.resize((1530, 710), Image.LANCZOS)
            self.photoimg3 = ImageTk.PhotoImage(img3)
            self.bg_img = Label(self.root, image=self.photoimg3)
            self.bg_img.place(x=0, y=150, width=1530, height=710)
        except:
            self.bg_img = Label(self.root, bg="white")
            self.bg_img.place(x=0, y=150, width=1530, height=710)
...
# ================== Title ==================
        ...
        # ================== Main Frame ==================
        main_frame = Frame(self.bg_img, bd=2, bg="white", relief=RIDGE)
        main_frame.place(x=10, y=50, width=1500, height=700)

 # ================== Left Frame ==================
        Left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                text="Student Details", font=("Times New Roman", 12, "bold"))
        Left_frame.place(x=10, y=10, width=800, height=600)


        try:
            img_left = Image.open(r"C:\Users\user\OneDrive\Desktop\Python_Test_Projects\college_iimages\OIP.jpeg")
            img_left = img_left.resize((720, 150), Image.LANCZOS)
            self.photoimg_left = ImageTk.PhotoImage(img_left)
            f_lbl2 = Label(Left_frame, image=self.photoimg_left)
            f_lbl2.place(x=5, y=0, width=720, height=150)
        except:
            f_lbl2 = Label(Left_frame, bg="lightgray")
            f_lbl2.place(x=5, y=0, width=720, height=150)

#current cource
        current_course = LabelFrame(Left_frame, bd=2, bg="white", relief=RIDGE,
                                   text="Current Course", font=("Times New Roman", 12, "bold"))
        current_course.place(x=5, y=135, width=720, height=160)
        ...
        dep_combo = ttk.Combobox(current_course, textvariable=self.var_dep, font=("Times New Roman", 12, "bold"), width=20, state="readonly")
        dep_combo['values'] = ("Select Department", "Computer", "IT", "Civil", "Mechanical", "CSE(AIML)")
        dep_combo.current(0)
        ...
        course_combo['values'] = ("Select Course", "B.Tech", "M.Tech", "BE", "MCA", "BCS", "LLB")
        ...
        year_combo.grid(row=0, column=3, padx=10, pady=5, sticky=W)

        sem_label = Label(current_course, text="Semester", font=("Times New Roman", 12, "bold"), bg="white")
        sem_label.grid(row=2, column=2, padx=10, sticky=W)
        ...
        sem_combo.current(0)
        sem_combo.grid(row=2, column=3, padx=10, pady=10, sticky=W)
...
#class
        ...
        class_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("time new roman",12,"bold"),width=17,state="readonly")
...
#gender
        ...
        gender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender,font=("time new roman",12,"bold"),width=17,state="readonly")
...
#bbuttons frame
        ...
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=10,font=("time new roman",12,"bold"),bg="blue",fg="white",cursor="hand2")
...
#right label frame
        ...
        try:
            img_left1 = Image.open(r"C:\Users\user\OneDrive\Desktop\Python_Test_Projects\college_iimages\OIP.jpeg")
            img_left1 = img_left1.resize((900,200),Image.LANCZOS)
            ...
            labelimg_left1 = Label(right_frame, bg="lightgray")
            labelimg_left1.place(x=0,y=0,width=900,height=200)

#=======Search System==========#

        search_student_frame = LabelFrame(right_frame,bd=2,relief=RIDGE,text="Search System",font=("time new roman",12,"bold"))
        search_student_frame.place(x=5,y=220,width=750,height=370)

        search_label=Label(search_student_frame,text='Search By:',font=("time new roman",15,"bold"),bg="white")
        search_label.grid(row=0,column=0,padx=0,sticky=W)

        search_combo=ttk.Combobox(search_student_frame,font=("time new roman",12,"bold"),width=17,state="readonly")
        search_combo["values"]=("select","Roll No","Phone_No")
        search_combo.current(0)
        search_combo.grid(row=0,column=1,padx=1,pady=10,sticky=W)

        search_entry=ttk.Entry(search_student_frame,width=20,font=("times new roman",10,"bold"))
        search_entry.grid(row=0,column=2,padx=10,pady=5,sticky=W)

        search_btn=Button(search_student_frame,text="Search",width=12,font=("time new roman",9,"bold"),bg="blue",fg="white",cursor="hand2")
        search_btn.grid(row=0,column=3,padx=4)

        showall_btn=Button(search_student_frame,text="Show All",width=12,font=("time new roman",9,"bold"),bg="blue",fg="white",cursor="hand2")
        showall_btn.grid(row=0,column=4,padx=4)
#table frame
        table_frame = Frame(right_frame,bd=2,bg="white")
        table_frame.place(x=5,y=300,width=650,height=230)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_id.get()=="" or self.var_name.get()=="" or self.var_teacher.get()=="":
            messagebox.showerror("Error","All Fields are required",parent=self.root)
        else:
            try:
                conn=mysql.connector.connect(host="localhost",user="root",password="Sunil@123",database="face_recognization")
                my_cursor=conn.cursor()
                my_cursor.execute("INSERT INTO student (Dep, course, year, sem, id, Name, Division, Roll, Gender, Dob, Email, Phone, Address, Teacher, PhotoSample) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", (
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
...
########update function##########
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="" or self.var_semester.get()=="Select Semester" or self.var_id.get()=="" or self.var_name.get()=="" or self.var_teacher.get()=="":
            messagebox.showerror("Error","All Fields are required",parent=self.root)
        else:
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",user="root",password="Sunil@123",database="face_recognization")
                    my_cursor=conn.cursor()
                    my_cursor.execute("UPDATE student SET Dep=%s, course=%s, year=%s, sem=%s, Name=%s, Division=%s, Roll=%s, Gender=%s, Dob=%s, Email=%s, Phone=%s, Address=%s, Teacher=%s, PhotoSample=%s WHERE id=%s", (
                        self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
                        self.var_semester.get(),
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_id.get()=="" or self.var_name.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                def face_cropped(img):
                    ...
                    faces=face_classifier.detectMultiScale(gray,1.1,5,minSize=(100,100))  # Optimized parameters
                ...
                img_id = 0
                max_images = 30  # Reduced from 100 to 30 images
                no_face_count = 0
                max_no_face = 15  # Stop if no face detected 15 times in a row
                
                messagebox.showinfo("Instructions", 
                                  "Face the camera clearly.\n"
                                  "Press ENTER to stop capturing.\n"
                                  f"Capturing {max_images} images maximum.", 
                                  parent=self.root)
                
                while img_id < max_images and no_face_count < max_no_face:
                    ...
                    if ret:
                        ...
                        if cropped_face is not None:
                            ...
                            # Save the face image
                            face = cv2.resize(cropped_face, (200, 200))  # Smaller for faster processing
                            face = cv2.cvtColor(face, cv2.COLOR_BGR2GRAY)
                            file_name_path = f"data/user.{self.var_id.get()}.{img_id}.jpg"
                            cv2.imwrite(file_name_path, face)
                            cv2.putText(face, str(img_id), (30, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
                            cv2.imshow("Cropped Face - Press ENTER to Stop", face)
                        else:
                            no_face_count += 1
                        
                        # Show preview window
                        cv2.imshow("Camera Preview - Press ENTER to Stop", my_frame)
                    
                        # Break conditions - ENTER key or reached max images
                ...
                if img_id > 0:
                    messagebox.showinfo("Success", f"Successfully captured {img_id} face samples!", parent=self.root)
                else:
                    messagebox.showwarning("Warning", "No face detected! Please try again in better lighting.", parent=self.root)
